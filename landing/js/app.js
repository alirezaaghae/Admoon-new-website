...
let rootUrl='https://admoon.agency/';
...
let secondowlOptions={loop:false,margin:20,smartSpeed:700,nav:false,dots:false,rtl:false,autoHeight:true,stagePadding:80,items:1,responsive:{0:{items:1,stagePadding:55},500:{stagePadding:80},600:{items:2},961:{items:2,stagePadding:40}}};
let firstowlOptions={loop:true,autoplay:true,autoplayTimeout:2500,autoplayHoverPause:true,margin:100,smartSpeed:700,nav:false,dots:false,rtl:false,autoHeight:true,items:1,responsive:{0:{items:1,margin:20,stagePadding:50},400:{items:2,margin:20,stagePadding:50},500:{items:2,margin:40,stagePadding:80},700:{items:1,margin:40},900:{items:2,margin:40},1100:{margin:100,items:3}}};
